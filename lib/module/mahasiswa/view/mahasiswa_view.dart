...
import 'package:hyper_ui/module/mahasiswa/controller/mahasiswa_controller.dart';

class MahasiswaView extends StatefulWidget {
  MahasiswaView({Key? key}) : super(key: key);

  Widget build(context, MahasiswaController controller) {
    controller.view = this;
    return Scaffold(
      appBar: AppBar(
        title: Text("Data Form Mahasiswa"),
        actions: [
          Padding(
  ...
  @override
  State<MahasiswaView> createState() => MahasiswaController();
}
